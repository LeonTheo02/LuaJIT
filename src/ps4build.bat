...
@set TARGETLIB=liblua51d.a
goto :BUILD
:NODEBUG
@if "%1" neq "production" goto :RELEASE
@set LJCOMPILE=%LJCOMPILE% -g -O2 -DLUA_USE_APICHECK -DLUA_USE_ASSERT -DPRODUCTION
@set TARGETLIB=liblua51p.a
goto :BUILD
:RELEASE
@set LJCOMPILE=%LJCOMPILE% -O2
@set TARGETLIB=liblua51.a
:BUILD
del %TARGETLIB%
